...
$query = mysqli_query($con, "SELECT * FROM `data_siswa` left join pengajuanpkl on pengajuanpkl.id_siswa=data_siswa.id_siswa where data_siswa.id_siswa = $id_siswa and status_validasi='Diterima'");
