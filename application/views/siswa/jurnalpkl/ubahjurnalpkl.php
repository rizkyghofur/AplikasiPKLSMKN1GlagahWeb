                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                ...
                                <input type="hidden" name="id_siswa" value="<?php echo $jurnalpkl->id_siswa ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control <?php echo form_error('topik_pekerjaan') ? 'is-invalid' : '' ?>" type="text" name="topik_pekerjaan"><?php echo htmlspecialchars($jurnalpkl->topik_pekerjaan) ?></textarea>
                                    <div class="invalid-feedback">
