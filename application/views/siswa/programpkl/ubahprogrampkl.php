                        ...
                        <?php } else { ?>
                            ...
                            <div class="card-body">
                                <form action="" method="post">
                                    ...
                                    <input type="hidden" name="id_program_pkl" value="<?php echo $programpkl->id_program_pkl ?>" />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control <?php echo form_error('topik_pekerjaan') ? 'is-invalid' : '' ?>" type="text" name="topik_pekerjaan" placeholder=""><?php echo $programpkl->topik_pekerjaan ?></textarea>
                                        <div class="invalid-feedback">
