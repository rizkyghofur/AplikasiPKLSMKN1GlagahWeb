                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <form action="" method="post">
                                ...
                                <input type="hidden" name="id" value="<?php echo $datadudi->id ?>" />

                                <div class="form-group">
                                    <label for="nama_dudi">Nama DUDI *</label>
                                    <input class="form-control <?php echo form_error('name') ? 'is-invalid' : '' ?>" type="text" name="nama_dudi" placeholder="Nama DUDI*" value="<?php echo $datadudi->nama_dudi ?>" />
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control <?php echo form_error('no_telp_dudi') ? 'is-invalid' : '' ?>" type="number" name="no_telp_dudi" min="0" placeholder="No Telp DUDI" value="<?php echo $datadudi->no_telp_dudi ?>"></input>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control <?php echo form_error('no_telp_pimpinan') ? 'is-invalid' : '' ?>" type="number" name="no_telp_pimpinan" min="0" placeholder="No Telp. Pembimbing DUDI" value="<?php echo $datadudi->no_telp_pimpinan ?>" />
                                    <div class="invalid-feedback">
