...
$route['admin/datadudi/(:any)'] = 'admin/datadudi/index/$1';
...
$route['admin/datasiswa/(:any)'] = 'admin/datasiswa/index/$1';
...
$route['admin/dataguru/(:any)'] = 'admin/dataguru/index/$1';
...
$route['admin/akun/(:any)'] = 'admin/akun/index/$1';
$route['admin/pengajuanpkl/(:any)'] = 'admin/pengajuanpkl/index/$1';
